...
using RevenueCompanion.Presentation.Services;
using RevenueCompanion.Presentation.Services.Interface;
using System;

namespace RevenueCompanion.Presentation
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<MerchantConfiguration>(Configuration.GetSection("MerchantConfiguration"));
