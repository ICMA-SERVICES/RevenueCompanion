$(function () {
    ...
    var user = document.getElementById('selectedUserId');
    ...
    function getPagesByRoleId(id) {
        ...
        var applicationUrl = baseUrl + 'v1.0/Menu/get-role-pages/' + id;
        $.ajax({
            headers: {
            ...
            success: function (response) {
                ...
                $("#table_pages_by_roleId_body tr").remove();
                //var firstRow = "<tr>"
                //    + "<td>" + "" + "</td>"
                //    + "<td>" + "" + "</td>"
    ...
    function getPagesByUserId(id) {
        ...
        var applicationUrl = baseUrl + 'v1.0/Menu/get-user-pages/' + id;
        $.ajax({
            headers: {
                'Authorization': bearerToken,
                'userPageSecret': id
            ...
            success: function (response) {
                var rowIndex = 1;
                var data = response.data;
                $("#table_pages_by_userId_body tr").remove();
                //var firstRow = "<tr>"
                //    + "<td>" + "" + "</td>"
                //    + "<td>" + "" + "</td>"
    ...
    function AssignPagestoUser(id) {
        ...
        var applicationUrl = baseUrl + 'v1.0/Menu/assign-to-user';
        $.ajax({
            headers: {
                'Authorization': bearerToken
            },
    ...
    function RemoveUserAssignedPages(id) {
        ...
        var applicationUrl = baseUrl + 'v1.0/Menu/remove-menu';
        $.ajax({
            headers: {
                'Authorization': bearerToken
            },
